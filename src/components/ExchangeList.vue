  ...
  <section class="posts">
    <div class="container">
      ...
      <div class="columns is-multiline">
        <div v-for="exchange in exchanges" :key="exchange.id" class="column is-12-mobile is-6-tablet is-4-widescreen is-6-desktop">
          <div class="item post-card bottom-border">
            ...
            <div class="item-tags">
              <a v-for="tag in exchange.tags" :key="tag" class="button is-rounded" href="#" title="Some Title">{{ `#${tag}` }}</a>
            </div>
